...
const modifyArray = (modificationCondition) => (data) => data.map(modificationCondition);
...
const inputArray = ["CusTom", "Web", "aNd", "MoBile", "PlaTfoRms"];

console.log('Capitalized Result:', capitalizeAllFirst(inputArray), 'Length:', capitalizeAllFirst(inputArray).length);
console.log('Lowercase Result:', allToLower(inputArray), 'Length:', allToLower(inputArray).length);
