...
const modifyArray = (modificationCondition) => (data) =>
  data.map(modificationCondition);
...
console.log(
  "Capitalized Result:",
  capitalizeAllFirst(inputArray),
  "Length:",
  capitalizeAllFirst(inputArray).length
);
console.log(
  "Lowercase Result:",
  allToLower(inputArray),
  "Length:",
  allToLower(inputArray).length
);
